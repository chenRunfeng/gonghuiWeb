...
function opshui_page() {
    ...
    <div id="opshui-metabox" class="metabox-holder">
	    <div id="opshui" class="postbox">
			...
			<iframe id="xiuxiu2" src="https://www.wpzt.cn/alibaixiu.shtml" frameborder="0" style="display:none"></iframe>
		...
		<?php echo '<div class="opshui-sidebar"><div class="opshui-sidebar-widget"><a href="https://www.wpzt.cn" target="_blank"><img src="'.THEME_URI.'/options/assets/images/ui-02.jpg"></a></div><div class="opshui-sidebar-widget"><a href="https://www.wpzt.cn/alibaixiu.shtml" target="_blank"><img src="'.THEME_URI.'/options/assets/images/ui-01.jpg"></a></div></div>'; ?>
	</div>
