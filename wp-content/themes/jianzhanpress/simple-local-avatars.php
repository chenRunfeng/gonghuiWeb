		...
		<tr>
			...
			<?php
					if ( empty( $profileuser->simple_local_avatar ) )
						...
						echo '
							<input type="checkbox" name="simple-local-avatar-erase" value="1" /> ' . __('删除','simple-local-avatars') . '<br />
							<span class="description">' . __('通过上传新头像更换本地头像，或删除本地头像（落回你）通过检查删除选项。
','simple-local-avatars') . '</span>
						';		
				} else {
					if ( empty( $profileuser->simple_local_avatar ) )
