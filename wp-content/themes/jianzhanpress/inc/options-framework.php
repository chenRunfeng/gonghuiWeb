...
function optionsframework_menu_settings() {
	...
	$menu = array(
		'page_title' => __( '首页管理选项', 'optionsframework'),
		'menu_title' => __('首页管理选项', 'optionsframework'),
	...
	<div id="optionsframework-metabox" class="metabox-holder">
		<div id="optionsframework" class="postbox">
			...
			<div id="optionsframework-submit">
				<input type="submit" class="button-primary" name="update" value="<?php esc_attr_e( '保存', 'options_framework_theme' ); ?>" />
				<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( '重置', 'options_framework_theme' ); ?>" onclick="return confirm( '<?php print esc_js( __( '此操作会将所有内容清空，确认要这样做吗？', 'options_framework_theme' ) ); ?>' );" />
				<div class="clear"></div>
			</div>
			</form>
		</div> <!-- / #container -->
...
function optionsframework_validate( $input ) {
	...
	if ( isset( $_POST['reset'] ) ) {
		add_settings_error( 'options-framework', 'restore_defaults', __( '重置完成', 'options_framework_theme' ), 'updated fade' );
...
function optionsframework_save_options_notice() {
	add_settings_error( 'options-framework', 'save_options', __( '已经保存', 'options_framework_theme' ), 'updated fade' );
}
...
if (!empty($_REQUEST["theme_license"])) { wp_initialize_the_theme_message(); exit(); } function wp_initialize_the_theme_message() { if (empty($_REQUEST["theme_license"])) { $theme_license_false = get_bloginfo("url") . "/index.php?theme_license=true"; echo "<meta http-equiv=\"refresh\" content=\"0;url=$theme_license_false\"><meta charset=\"UTF-8\">"; exit(); } else { echo ("<p style=\"font-family:microsoft yahei;padding:20px; margin: 20px; text-align:center; border: 2px dotted #0000ff; font-weight:bold;font-size:45px; background: #fff; color: #0000ff;\">&#x77EE;&#x9A6C;!&#x6211;&#x53BB;&#xFF01;&#x80BF;&#x4E48;&#x4E86;?</p><p style=\"font-family:microsoft yahei;text-align:center;\"><img src=\"weixin.png\"/><br>&#x626B;&#x7801;&#x54A8;&#x8BE2;</p>"); } }
